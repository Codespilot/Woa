...
public static class ExpressionExtensions
{
	...
	public static Expression<Func<T, bool>> Aggregate<T>(this IEnumerable<Expression<Func<T, bool>>> expressions, Expression<Func<T, bool>> seed, string link = "And")
	{
		var predicate = expressions.Aggregate(seed, (current, next) => link == "And" ? current.And(next) : current.Or(next));
		return predicate;
	}
}