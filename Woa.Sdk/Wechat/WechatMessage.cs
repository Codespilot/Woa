...
public class WechatMessage : Dictionary<string, object>
{
	...
	public T GetValue<T>(string key, Func<object, T> func)
	{
	...
	public static WechatMessage Empty => null;

	public static WechatMessage Text(string content)
	{
		return new WechatMessage(WechatMessageType.Text)
		{
			[WechatMessageKey.Reply.Content] = content
		};
	}
